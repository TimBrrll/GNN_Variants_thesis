...
class Dataset_data(InMemoryDataset):
    ...
    def process(self):
        ...
        matrices = pre.get_local_sparse_tupleset_matrices_2(
    ...
    for i in range(repetitions):
        ...
        for train_index, test_index in kfold.split(range(len(dataset))):
            ...
            for hu in hidden_units:
                ...
                print(
                    f"The ST-K-LGNN needed for the {dataset_info[0]} around {np.array(times).mean()} seconds to run 100 Epochs"
                )
...
if __name__ == "__main__":
    ...
    for dataset in dataset_name:
        ...
        print("#####################################################")
        print(
            f"FINAL RESULT ST-K-LGNN for {dataset}, mean_losses: {loss}, std_losses: {std}"
        )
        print("#####################################################")
        shutil.rmtree("code/main_methods/datasets")
        shutil.rmtree("code/main_methods/data")
    ...
    for dataset in big_dataset_names:
        ...
        print("#####################################################")
        print(
            f"FINAL RESULT ST-K-LGNN for {dataset[0]}: mean_losses: {loss}, std_losses: {std}"
        )
        print("#####################################################")
        shutil.rmtree("code/main_methods/datasets")
        shutil.rmtree("code/main_methods/data")
